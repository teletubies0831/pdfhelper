...
export function isSourcePdfCurrentlyOpen(documentName: string): boolean {
...
export async function ensureSourcePdfOpen(
  ...
  if (isSourcePdfCurrentlyOpen(documentName)) return true;
  ...
  return isSourcePdfCurrentlyOpen(documentName);
}
